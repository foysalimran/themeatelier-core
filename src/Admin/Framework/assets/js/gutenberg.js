...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.THEMEATELIER_CORE_gutenberg_blocks ) { return; }

  Object.values(window.THEMEATELIER_CORE_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'themeatelier-core-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary themeatelier-core-shortcode-button',
              onClick: function () {
                window.THEMEATELIER_CORE_gutenberg_props = props;
              },
            }, block.button_title ),
