...
(function($) {
  ...
  function THEMEATELIER_COREAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  THEMEATELIER_COREAjaxChosen.prototype.init = function() {
  ...
  THEMEATELIER_COREAjaxChosen.prototype.events = function() {
  ...
  THEMEATELIER_COREAjaxChosen.prototype.search_field_focused = function() {
  ...
  THEMEATELIER_COREAjaxChosen.prototype.search_welcome_message = function() {
  ...
  THEMEATELIER_COREAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('themeatelier-core-chosen', _this.options.data).done( function( response ) {
  ...
  THEMEATELIER_COREAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.themeatelier-core-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.THEMEATELIER_COREChosenOrder($hidden_value, true);
  ...
  $.fn.THEMEATELIER_COREAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new THEMEATELIER_COREAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, THEMEATELIER_COREAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  THEMEATELIER_COREAbstractChosenOrder = (function() {

    function THEMEATELIER_COREAbstractChosenOrder() {}

    THEMEATELIER_COREAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    THEMEATELIER_COREAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    THEMEATELIER_COREAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    THEMEATELIER_COREAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    THEMEATELIER_COREAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    THEMEATELIER_COREAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    THEMEATELIER_COREAbstractChosenOrder.THEMEATELIER_COREChosenOrder = function(select, order, force) {
    ...
    return THEMEATELIER_COREAbstractChosenOrder;
  ...
  $.fn.extend({
    THEMEATELIER_COREChosenOrder: function(order, force) {
      return _THEMEATELIER_COREChosenOrder.THEMEATELIER_COREChosenOrder(this, order, force);
    }
  });

  this._THEMEATELIER_COREChosenOrder = (function(_super) {
    __extends(_THEMEATELIER_COREChosenOrder, _super);

    function _THEMEATELIER_COREChosenOrder() {
      _ref = _THEMEATELIER_COREChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _THEMEATELIER_COREChosenOrder.relAttributeName = 'data-option-array-index';

    _THEMEATELIER_COREChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _THEMEATELIER_COREChosenOrder.getDOMElement = function(element) {
    ...
    _THEMEATELIER_COREChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _THEMEATELIER_COREChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _THEMEATELIER_COREChosenOrder;

  })(THEMEATELIER_COREAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('themeatelier-core-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('themeatelier-core-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectTHEMEATELIER_CORE = FormSerializer.serializeObject;
    $.fn.serializeJSONTHEMEATELIER_CORE   = FormSerializer.serializeJSON;
  }
