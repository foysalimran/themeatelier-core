 ...
 *
 */
if ( ! class_exists( 'THEMEATELIER_CORE_Walker_Nav_Menu_Edit' ) && class_exists( 'Walker_Nav_Menu_Edit' ) ) {
  class THEMEATELIER_CORE_Walker_Nav_Menu_Edit extends Walker_Nav_Menu_Edit {
