 ...
 *
 */
if ( ! class_exists( 'Themeatelier_Core_Fields' ) ) {
  abstract class Themeatelier_Core_Fields extends THEMEATELIER_CORE_Abstract {
    protected $field;
    protected $value;
    protected $unique;
    protected $where;
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="themeatelier-core-before-text">'. $this->field['before'] .'</div>' : '';
    }

    public function field_after() {

      $output  = ( ! empty( $this->field['after'] ) ) ? '<div class="themeatelier-core-after-text">'. $this->field['after'] .'</div>' : '';
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="themeatelier-core-desc-text">'. $this->field['desc'] .'</div>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<div class="themeatelier-core-help"><span class="themeatelier-core-help-text">'. $this->field['help'] .'</span><i class="icofont-question-circle"></i></div>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="themeatelier-core-error-text">'. $this->field['_error'] .'</div>' : '';
