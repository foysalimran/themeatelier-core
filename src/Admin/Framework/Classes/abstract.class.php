...
if ( ! class_exists( 'THEMEATELIER_CORE_Abstract' ) ) {
  abstract class THEMEATELIER_CORE_Abstract {
    ...
    public function __construct() {
      ...
      if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
        ...
        THEMEATELIER_CORE::$css = apply_filters( "THEMEATELIER_CORE_{$this->unique}_output_css", THEMEATELIER_CORE::$css, $this );
      }
    ...
    public function recursive_output_css( $fields = array(), $combine_field = array() ) {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          $field_class  = 'Themeatelier_Core_Field_' . $field_type;
            ...
            if ( class_exists( $field_class ) ) {
              ...
              if ( method_exists( $field_class, 'output' ) || method_exists( $field_class, 'enqueue_google_fonts' ) ) {
                ...
                if ( $field_output && $this->args['output_css'] ) {
                  THEMEATELIER_CORE::$css .= $instance->output();
                }
